...
public class HumanReadableDurationTest {
  ...
  public void testFormatDurationExampleTwo() {
    ...
    MatcherAssert.assertThat(
        "1 minute and 2 seconds", Matchers.is(HumanReadableDuration.formatDuration(62)));
  }
  ...
  public void testFormatDurationExampleFive() {
    // Example Test Cases
    MatcherAssert.assertThat(
        "1 hour, 1 minute and 2 seconds", Matchers.is(HumanReadableDuration.formatDuration(3662)));
  }
  ...
  public void testFormatDurationExampleSix() {
    // Example Test Cases
    MatcherAssert.assertThat(
        "31 years, 85 days, 6 hours, 56 minutes and 24 seconds",
        Matchers.is(HumanReadableDuration.formatDuration(984984984)));
  }
