...
public class FindUniqueTest {
  ...
  public void sampleTestCases() {
    MatcherAssert.assertThat(
        1.0, CoreMatchers.equalTo(FindUnique.findUniq(new double[] {0, 1, 0})));
    MatcherAssert.assertThat(
        2.0, CoreMatchers.equalTo(FindUnique.findUniq(new double[] {1, 1, 1, 2, 1, 1})));
  }
  ...
  public void testCases() {
    ...
    MatcherAssert.assertThat(
        FindUnique.findUniq(testCase), CoreMatchers.equalTo(testCase[testCase.length - 1]));
  }
